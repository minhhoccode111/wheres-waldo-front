  ...
  return (
    <section className="mx-auto my-12 p-4 max-w-[65ch] w-full text-slate-700">
      ...
      <article className="flex flex-col gap-3 py-4">
        <p className="">Find 3 hidden characters as fast as possible.</p>
        <p className="">
          Made by{' '}
          <a
            ...
            target="_blank"
            rel="noopener"
            className="text-sky-500 underline decoration-dotted hover:decoration-solid"
          >
            minhhoccode111
          </a>
        </p>
        ...
        <p className="">
          To showcase the{' '}
          <a
            href="https://github.com/minhhoccode111/wheres-waldo-back"
            target="_blank"
            rel="noopener"
        ...
        <p className="">
          This project&apos;s backend uses free tier hosting on Glitch, which
          can cause significant delays in the server&apos;s response time for
          API requests or data fetching.
        </p>
      </article>
    </section>
  );
